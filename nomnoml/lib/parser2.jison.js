...
yy: {},
symbols_: {"error":2,"expressions":3,"compartment":4,"EOF":5,"slot":6,"IDENT":7,"class":8,"relation":9,"SEP":10,"parts":11,"|":12,"ASSOC":13,"[":14,"]":15,"[<":16,">":17,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"IDENT",10:"SEP",12:"|",13:"ASSOC",14:"[",15:"]",16:"[<",17:">"},
productions_: [0,[3,2],[6,1],[6,1],[6,1],[4,1],[4,3],[11,1],[11,3],[9,3],[9,4],[9,4],[9,5],[8,3],[8,5]],
...
case 8:this.$ = [$$[$0-2],$$[$0]];
break;
case 9:this.$ = {r:$$[$0-1], start:$$[$0-2], end:$$[$0], startLabel:'', endLabel:''};
break;
case 10:this.$ = {r:$$[$0-1], start:$$[$0-3], end:$$[$0], startLabel:$$[$0-2], endLabel:''};
break;
case 11:this.$ = {r:$$[$0-2], start:$$[$0-3], end:$$[$0], startLabel:'', endLabel:$$[$0-1]};
break;
case 12:this.$ = {r:$$[$0-2], start:$$[$0-4], end:$$[$0], startLabel:$$[$0-3], endLabel:$$[$0-1]};
break;
case 13:this.$ = {t:'CLASS', parts:$$[$0-1]};
break;
case 14:this.$ = {t:$$[$0-3].toUpperCase(), parts:$$[$0-1]};
break;
}
},
table: [{3:1,4:2,6:3,7:[1,4],8:5,9:6,14:[1,7],16:[1,8]},{1:[3]},{5:[1,9],10:[1,10]},{5:[2,5],10:[2,5],12:[2,5],15:[2,5]},{5:[2,2],10:[2,2],12:[2,2],15:[2,2]},{5:[2,3],7:[1,12],10:[2,3],12:[2,3],13:[1,11],15:[2,3]},{5:[2,4],10:[2,4],12:[2,4],15:[2,4]},{4:14,6:3,7:[1,4],8:5,9:6,11:13,14:[1,7],16:[1,8]},{7:[1,15]},{1:[2,1]},{6:16,7:[1,4],8:5,9:6,14:[1,7],16:[1,8]},{7:[1,18],8:17,14:[1,7],16:[1,8]},{13:[1,19]},{12:[1,21],15:[1,20]},{10:[1,10],12:[2,7],15:[2,7]},{17:[1,22]},{5:[2,6],10:[2,6],12:[2,6],15:[2,6]},{5:[2,9],10:[2,9],12:[2,9],15:[2,9]},{8:23,14:[1,7],16:[1,8]},{7:[1,25],8:24,14:[1,7],16:[1,8]},{5:[2,13],7:[2,13],10:[2,13],12:[2,13],13:[2,13],15:[2,13]},{4:26,6:3,7:[1,4],8:5,9:6,14:[1,7],16:[1,8]},{4:14,6:3,7:[1,4],8:5,9:6,11:27,14:[1,7],16:[1,8]},{5:[2,11],10:[2,11],12:[2,11],15:[2,11]},{5:[2,10],10:[2,10],12:[2,10],15:[2,10]},{8:28,14:[1,7],16:[1,8]},{10:[1,10],12:[2,8],15:[2,8]},{12:[1,21],15:[1,29]},{5:[2,12],10:[2,12],12:[2,12],15:[2,12]},{5:[2,14],7:[2,14],10:[2,14],12:[2,14],13:[2,14],15:[2,14]}],
